...
class DetailRevenueProduit extends StatefulWidget {
  final EntreesProd entree;
  DetailRevenueProduit({Key key, this.entree}) : super(key: key);

  @override
  State<DetailRevenueProduit> createState() => _DetailRevenueProduitState();
}
...
class _DetailRevenueProduitState extends State<DetailRevenueProduit> {
  @override
  void initState() {
