...
class DetailRevenueClient extends StatefulWidget {
  final EntreesClient entree;
  final EntreesProd entreesProd;
  const DetailRevenueClient({Key key, this.entree , this.entreesProd}) : super(key: key);

  @override
  State<DetailRevenueClient> createState() => _DetailRevenueClientState();
}
...
class _DetailRevenueClientState extends State<DetailRevenueClient> {
  @override
  void initState() {
                    ...
                    child: DetailCard(
                      ...
                      press: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return DetailCheques(detail: det[i]);
                            },
                          ),
                        );
                      },
