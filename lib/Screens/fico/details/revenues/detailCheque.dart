...
class DetailCheques extends StatefulWidget {
  final Details detail;

  const DetailCheques({Key key, this.detail}) : super(key: key);
  @override
  State<DetailCheques> createState() => _DetailChequesState();
}

class _DetailChequesState extends State<DetailCheques> {
  @override
  void initState() {
